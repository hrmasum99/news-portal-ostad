...
import { FaEnvelope, FaLock, FaUser, FaNewspaper } from 'react-icons/fa';
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 animate-slide-up">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="flex items-start space-x-2 cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 mt-1 text-primary-600 border-dark-300 rounded focus:ring-primary-500"
                    required
                  />
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center space-x-2 px-4 py-3 border-2 border-dark-200 rounded-lg hover:bg-dark-50 transition-colors">
                ...
                <span className="font-medium text-dark-700">Google</span>
              </button>
              <button className="flex items-center justify-center space-x-2 px-4 py-3 border-2 border-dark-200 rounded-lg hover:bg-dark-50 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
                <span className="font-medium text-dark-700">Facebook</span>
              </button>
            </div>
